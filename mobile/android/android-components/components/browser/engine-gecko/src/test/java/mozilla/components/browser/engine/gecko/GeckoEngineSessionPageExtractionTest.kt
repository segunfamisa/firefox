...
class GeckoEngineSessionPageExtractionTest {
            ...
            object : Handler() {
                override fun sendMessageAtTime(msg: Message, uptimeMillis: Long): Boolean {
                    ...
                    return super.sendMessageAtTime(
                        Message.obtain(this, wrappedRunnable),
                        uptimeMillis,
                    )
                }
            },
    ...
    @Test
    fun `given page extractor returns a null, then an unexpected null error is received`() {
    ...
    @Test
    fun `given page extractor returns a null content exception, then an unexpected null error is received`() {
