    ...
    data class ListBlock(
        ...
        data class ListItem(val content: List<BlockContent>) {
            val paragraph: Paragraph?
                get() = content.firstOrNull { it is Paragraph } as? Paragraph

            /**
             * A list item may contain an optional nested list block
             */
            val nestedList: ListBlock?
                get() = content.firstOrNull { it is ListBlock } as ListBlock?
        }
    }
